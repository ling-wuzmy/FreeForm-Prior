...
from vm_ik.models import simple3dmesh, noise_reduction
from vm_ik.utils.mesh import Mesh
...
class Simple3DMesh_Post(nn.Module):
    ...
    def forward(self, x, trans_inv, intrinsic_param, joint_root, depth_factor, flip_item=None, flip_output=False, flip_mask=None, is_train=True, gt_param_pose=None, gt_param_shape=None, gt_param_trans=None, is_up3d=None, cam_param=None):
        ...
        pred_xyz_jts, pred_uvd_jts_flat, adaptive_A, confidence, mesh3d, _, pred_root_xy_img = self.simple3dmesh(x, trans_inv, intrinsic_param, joint_root, depth_factor, flip_item, flip_output, flip_mask)       # (B, J+K, 3), (B, J+K)
        ...
        return pred_xyz_jts, pred_uvd_jts_flat, adaptive_A, confidence, mesh3d_ret, mesh3d_post, pred_root_xy_img
