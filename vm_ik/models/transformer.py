...
class Transformer(nn.Module):
    ...
    def forward(self, img_features, jv_tokens, pos_embed, attention_mask=None):
        ...
        # Transformer Encoder 
        e_outputs = self.encoder(img_features, src_key_padding_mask=mask, pos=pos_embed) # (1 + height * width) X batch_size X feature_dim
        enc_img_features = e_outputs 
        ...
        return enc_img_features, jv_features
